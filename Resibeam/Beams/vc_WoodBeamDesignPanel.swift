...
class vc_WoodBeamDesignPanel: NSViewController, NSTableViewDataSource, NSTableViewDelegate, MWFactorReceiver{
    ...
    override func viewWillAppear() {
        ...
        delegate?.updateSaveDocWithSelectedDesignTabIndex(selectedTabIndex: 0)
        updateStatus()
    }
